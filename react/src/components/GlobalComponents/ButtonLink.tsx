...
const ButtonLink: React.FC<MyComponentProps> = ({ name, link, onClick = false }) => {
  ...
  return (
    <div className="relative inline-block z-20">
      <Link
        to={link}
        className="relative bg-[#D9D9D9] text-black border-2 border-black rounded-[30px] cursor-pointer inline-block font-semibold text-[16px] md:text-[18px] px-[30px] leading-[55px] text-center no-underline select-none mb-5 mt-3 ml-2 transition-transform duration-200 max-w-[200px] md:w-[200px]
